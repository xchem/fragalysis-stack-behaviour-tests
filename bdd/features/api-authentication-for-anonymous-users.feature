Feature: Key GET methods need authentication
  ...
  Rule: Some GET methods should fail for anonymous users

    Scenario Outline: Some GET methods should return 'Not Authorized'
    ...
    Scenario Outline: Some GET methods should return 'Not Allowed'
      When I call <method> on the behaviour stack
